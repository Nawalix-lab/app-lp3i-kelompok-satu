...
export default function EditProdukScreen() {
  ...
  useEffect(() => {
    async function loadProduct() {
      ...
      if (error) {
        Toast.show({
          type: 'error',
          text1: 'Gagal memuat data produk',
          text2: error.message,
          position: 'top',
          visibilityTime: 3000,
        })
  ...
  async function handleUpdate() {
    ...
    if (isNaN(parseInt(price))) {
      Toast.show({
        type: 'error',
        text1: 'Harga harus berupa angka!',
        position: 'top',
        visibilityTime: 3000,
      });
      setLoading(false);
    ...
    if (priceNumber < 0) {
      Toast.show({
        type: 'error',
        text1: 'Harga tidak boleh negatif!',
        position: 'top',
        visibilityTime: 3000,
      });
      setLoading(false);
    ...
    try {
      ...
      Toast.show({
        type: 'success',
        text1: 'Sukses',
        text2: 'Data produk berhasil diperbarui!',
        position: 'top',
        visibilityTime: 3000,
      });
    ...
    <KeyboardAvoidingView style={{ flex: 1 }}
      ...
      <View className="flex-1 bg-white dark:bg-gray-900">
        ...
        <ScrollView className="flex-1 px-5 pt-6" contentContainerStyle={{ paddingBottom: 40 }}>
          ...
          <View className="flex-row gap-4 mb-4">
            <View className="flex-1">
              <Text className="text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Harga<Text className="text-red-500">*</Text></Text>
            ...
            <View className="w-1/3">
              <Text className="text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Satuan<Text className="text-red-500">*</Text></Text>
