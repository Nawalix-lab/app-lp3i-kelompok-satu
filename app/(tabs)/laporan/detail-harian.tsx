...
                    <p style="font-size: 10px; font-weight: 600; color: #374151; margin-bottom: 5px;">Detail Item (${item.transaction_items?.length || 0} Jenis Produk)</p>
...
    // --- FUNGSI MENGAMBIL DATA DARI SUPABASE (DIPERBARUI) ---
...
            // 2. Memperbaiki query dengan FILTER USER_ID
...
    useFocusEffect(useCallback(() => { 
        // Panggil fetchData setiap kali screen ini fokus atau parameter 'date' berubah
        fetchData(); 
    }, [date])); 
...
                        {productName} (<Text className="font-semibold">{quantity}x</Text>)
                    </Text>
                    
...
                        Detail Item (<Text className="font-bold text-gray-900">{totalItemsCount}</Text> Jenis Produk)
                    </Text>
                    
