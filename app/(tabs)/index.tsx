...
import "../../global.css"; // Pastikan NativeWind sudah dikonfigurasi
...
export default function HomeScreen() {
  ...
  // 1. Cek Session User saat layar fokus
  useFocusEffect(
    useCallback(() => {
      fetchUserAndStats();
    }, [])
        ...
        <View className="bg-white pt-10 pb-6 px-5 flex-row items-center justify-between border-b border-gray-100 shadow-sm mb-4">
          ...
          <View className="flex-row items-center">
            ...
            <TouchableOpacity
              ...
              className="h-11 w-11 rounded-full bg-gray-100 border border-gray-200 items-center justify-center overflow-hidden"
            >
              {avatarUrl ? (
                <Image
